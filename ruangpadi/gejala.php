...
<body class="d-flex flex-column h-100">
  <main class="flex-shrink-0">
    ...
    <div class="col-sm-8 text-left mx-auto">
      ...
      <center>
        <h2 class="display-5 fw-bolder"><span class="text-primary d-inline">Daftar Gejala</span></h2>
      </center>
            ...
            if ($_POST['tanaman'] != "jenistanaman") {
              ...
              while ($data = mysqli_fetch_array($hasil)) {
                ...
                echo "      
                  ...
                  <td>" . $data[2] . "</td>
                  <td>" . $data[3] . "</td>
                  <td><a href=\"aeditgejala.php?id=" . $data[0] . "\"><i class='bi bi-pencil'></i></a> | <a href=\"adeletegejala.php?id=" . $data[0] . "\"  onclick='return checkDelete()'><i class='bi bi-trash'></i></a></td>
                  </tr>   
                  ";
              }
            }
